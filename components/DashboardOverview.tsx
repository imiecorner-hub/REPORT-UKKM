      ...
      <div className="bg-white rounded-2xl border border-red-100 shadow-sm p-4 md:p-6 relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-4">
            <div className="flex flex-col md:flex-row gap-4 items-start p-3 bg-red-50/50 rounded-xl border border-red-100">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
          <div>
            <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
              ...
              Takwim & Jadual Aktiviti
            </h3>
            <p className="text-sm text-slate-500">Paparan aktiviti tahunan Unit Keselamatan Makanan.</p>
          </div>
          <a 
            href="https://calendar.google.com" 
            target="_blank" 
            rel="noreferrer"
            className="w-full md:w-auto px-4 py-2 bg-white border border-slate-200 text-slate-700 font-medium rounded-lg hover:bg-slate-50 hover:text-blue-600 transition-colors text-sm flex items-center justify-center gap-2 shadow-sm"
          >
            <ExternalLink className="w-4 h-4" />
            Buka Google Calendar Saya
          </a>
        </div>
        
        <div className="bg-slate-50 rounded-xl border border-slate-200 overflow-hidden h-[500px] md:h-[600px] w-full">
           <iframe 
